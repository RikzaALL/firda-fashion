<section id="gallery" class="py-20 lg:py-32">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @php
            $items = [
                ['Gaun Pesta', 'Elegan & Mewah', 'gaunPesta.webp'],
                ['Kemeja Formal', 'Rapi & Profesional', 'kemeja_formal.webp'],
                ['Busana Muslim', 'Sopan & Modern', 'busana_muslim.jpg'],
                ['Kebaya', 'Tradisional & Anggun', 'kebaya.jpg'],
                ['Blus Wanita', 'Cantik & Trendy', 'blus_wanita.avif'],
                ['Jas Pria', 'Klasik & Premium', 'jas_pria.jpg'],
            ];
        @endphp
            ...
            <div class="overflow-hidden">
                <div class="flex gap-6 transition-transform duration-500 ease-out"
                    ...
                    <div class="group relative overflow-hidden bg-muted w-72 sm:w-80 aspect-[4/5] shrink-0 cursor-pointer">
                        <img src="{{ asset('assets/' . $item[2]) }}" alt="{{ $item[0] }}" class="w-full h-full object-cover">
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('galleryData', () => ({
            ...
            get maxOffset() {
                return Math.max(0, this.trackWidth - this.viewportWidth);
            },
            get offset() {
