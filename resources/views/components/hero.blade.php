    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div class="space-y-8 py-12 lg:py-20">
                ...
                <p class="font-display text-xl sm:text-2xl lg:text-3xl text-accent font-medium italic">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="#gallery" class="inline-flex items-center gap-2 px-6 py-3 bg-accent text-white font-medium text-sm rounded-none hover:bg-accent/90 transition-all duration-300">
                        Gallery Jahit
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                        </svg>
                    </a>
                    <a href="#kontak" class="inline-flex items-center gap-2 px-6 py-3 border-2 border-primary text-primary font-medium text-sm rounded-none hover:bg-accent hover:border-accent hover:text-white transition-all duration-300">
                        Hubungi Kami
                    </a>
                </div>
            </div>
            ...
            <div class="relative mt-12 lg:mt-0">
                <div class="aspect-[3/4] bg-gradient-to-br from-primary/10 to-secondary/10 relative overflow-hidden">
                    <img src="{{ asset('assets/model_hayya.webp') }}" alt="Hayya Modiste Model" class="w-full h-full object-cover">
